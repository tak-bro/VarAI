...
✔ Successfully published branch! Install with command:
  → npm i 'tak-bro/varai#npm/develop'
```

> Note: The `tak-bro/varai` will be replaced with your fork's URL.

Now, you can run the branch in your project:

```sh
$ pnpm dlx 'tak-bro/varai#npm/develop' # same as running `npx varai`
```
